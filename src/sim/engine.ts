...
export function advanceYear(s: SimState): SimState {
  ...
  // Income grows ~7%/yr, with a chance of a bigger jump
  const raise = 0.06 + Math.random() * 0.04
