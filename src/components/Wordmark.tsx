  ...
  return (
    <span className="inline-flex items-center gap-2">
      <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden>
        <circle cx="16" cy="19" r="11" fill="url(#fl-coin)" stroke="#065f46" strokeWidth="1.5" />
        <path d="M16 19c-2.6 0-4-1.4-4-3.2 0-1.3 1-2.3 2.6-2.6M16 19c2.6 0 4 1.3 4 3.1 0 1.4-1.1 2.4-2.8 2.7M16 11.5V25"
          stroke="#053b2b" strokeWidth="1.7" strokeLinecap="round" />
        {/* sprout */}
        <path d="M16 11c0-2.5-1.6-4.4-4.2-4.8C12 8.7 13.6 10.6 16 11Z" fill="#34d399" />
        <path d="M16 10.4c0.4-2.5 2.3-4.2 4.9-4.2C20.4 8.6 18.5 10.2 16 10.4Z" fill="#6ee7b7" />
        <defs>
